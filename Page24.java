...
public class Page24 extends JFrame implements ActionListener
{
    ...
    public Page24()
    {
        ...
        product_and_price.put("Dissociative Identity Disorder (DID)", "80");
        product_and_price.put("Narcissistic Personality Disorder (NPD)", "10");
        product_and_price.put("Antisocial Personality Disorder (ASPD)", "7");
        product_and_price.put("Substance Use Disorders (SUD)", "40");
        product_and_price.put("Avoidant Personality Disorder (AvPD)", "5");
		product_and_price.put("Unknown", "400");
        product_name_bill = new DefaultListModel<>();
        product_price_bill = new DefaultListModel<>();
        product_quantity_bill = new DefaultListModel<>();
        
        product_name = new JLabel("Problem");
        quantity_label = new JLabel("Quantity of People ");
        price_per_unit = new JLabel("Price Per Treatment(৳)");
        ...
        bill_product = new JLabel("Treatment");
        ...
        add_product = new JButton("Add Treatment");
